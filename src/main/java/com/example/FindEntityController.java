...
public class FindEntityController {
	...
	*/
	...
	@CrossOrigin
	@RequestMapping(value = "/DownloadDocumentnggrid",method = RequestMethod.GET)
	public void downloadnggridDocumnet(HttpServletRequest request,
            HttpServletResponse response) throws IOException {
		// TODO Auto-generated method stub
       ...
       // String fullPath = appPath+"\\DocumnetStore\\"+"Response.csv";
        String fullPath = "nggrid_document_rahul.rar";
	...
	@CrossOrigin
	@RequestMapping(value = "/DownloadAngularDocument",method = RequestMethod.GET)
	public void downloadAngularDocumnet(HttpServletRequest request,
            HttpServletResponse response) throws IOException {
		// TODO Auto-generated method stub
       ...
       // String fullPath = appPath+"\\DocumnetStore\\"+"Response.csv";
        String fullPath = "angular tutorial.rar";
